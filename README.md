# 🤗혼자서 딥러닝 프로젝트를 진행하기 위해 예제코드를 fork
- 📚**책에서 제공하는 예제코드 레포지토리를 fork 해서 주석을 추가하며 자습하는 형태**
- 💻**목적: Transformer 이해, 자연어 처리 모델 이해(BERT, GPT), 허깅 페이스 사용법 익히기**

## 📝 작업 일지

| 날짜 | 내용 |
|------|------|
| 2026-03-24 | 예제 2.01 PretrainedConfig 클래스 주석 추가 |

<br/>
아래는 원본 레포지토리에서 제공하는 README입니다.
<br/>
